...
SELLER_PRACA = {  # canônico -> label praça
 ...
 'Bruna Dias':'Ribeirão Preto SPI','Tiago Silva':'Ribeirão Preto SPI','Jamson Santos':'Feira de Santana',  # novos 22/09 (Felipe 22/09)
...
FORCE_APPROVED = {
  ...
  # ATENCAO: a data forcada NAO expira - tirar estes 3 na virada de mes.
                  ...
                  'ecae8e1b-25cf-4268-b61d-da32950bb1f7': '2026-09-21',  # ERIKA GOMES PEREIRA (GD LIORA_F_, Anderson Correia/Campinas SPI, 3.915 MWh) - leva o Anderson de 4.49 para 8.41 MWh camp. e CRUZA a faixa de 8: R$ 0 -> R$ 1.500
                  '800f8619-e760-4711-91b8-d5959e429858': '2026-09-21',  # JOSE TARCISE DUARTE JUNIOR (Antecipa PF, Ederson Silva/Campinas SPI, 0.42 MWh, Monte Mor) - leva o Ederson de 4.81 para 5.44 MWh camp. e CRUZA AS DUAS faixas (5 MWh e 10 clientes Antecipa): R$ 500 -> R$ 1.500. ATENCAO: o pagamento de 24/09 ja tinha saido com R$ 500.
                  'b3da467b-445f-4545-a958-c8a24ca76c2f': '2026-09-21',  # ADRIANO CESAR SOARES (Antecipa PF, Ederson Silva/Campinas SPI, 0.306 MWh, Sao Joaquim da Barra) - NAO muda faixa: o Ederson ja esta em 5.44 MWh e 10 Antecipa; vai para 5.90 e 11, segue R$ 1.500.
...
def _mesma_semana_paga(a, b):
    ...
    if not a or not b or a[:7] != b[:7]:
        return False
    da, db = pdate(a), pdate(b)
    if not da or not db:
        return False
    return semana(da) == semana(db)
...
INJECT_DEALS = [
    {'deal_id': '9b7ea565-4c5e-49b1-872d-1c72ad59ee91', 'proposal_id': '59295c95-3264-4e5b-ac0c-5fdf8b5a0516', 'current_client_name': 'Rosangela de Melo', 'current_client_cpf': '00844332488', 'current_client_cnpj': '', 'client_phone_number': '+5584999311260', 'current_client_city': 'MOSSORO', 'current_client_state': 'RN', 'distributor_short_name': 'NEOENERGIA COSERN', 'sales_person_email': 'lucas.santos@lioraenergia.com.br', 'sales_person_name': 'Lucas Santos', 'sales_team': 'Field Sales', 'sales_channel_name': '[FS] Liora Antecipa PF', 'internal_sales_classification': 'Outro', 'product_name': 'LIORA_ANTECIPA_PF', 'current_consumption_filled': '0.195', 'current_total_bill_cost (R$)': '210.88', 'deal_stage': 'REQUEST_TITULARIDADE', 'deal_lost_at': '', 'deal_lost_reason': '', 'deal_created_at': '2026-08-24 09:18:21', 'proposal_created_at': '2026-08-24 09:18:22', 'latest_risk_analysis_result': 'APPROVED', 'latest_risk_analysis_created_at': '2026-09-10 23:09:44', 'latest_risk_analysis_comments': 'Pix.', 'latest_credit_analysis_result': '', 'deal_credit_stage': 'PAYMENT_SUCCEDED', 'latest_contract_id': 'a449f0f3-b461-464c-b98e-a9adc6df9245', 'ops_tt_status': 'N/A', 'idle_days': '0', 'accepted_proposal': 'true', 'signer_name': '', 'origin_campaign': '', 'origin_source': ''},  # ROSANGELA DE MELO - Antecipa PF (Lucas Santos/RN, Mossoro, 0.195 MWh): proposta de 24/08 fica FORA do recorte do mes, entao o FORCE_APPROVED sozinho ficava inerte. Risco APPROVED 10/09 23:09 BRT + PAYMENT_SUCCEDED (Pix) sem credit_analyses. Injetado 14/09 (Felipe). REMOVER quando a base/recorte trouxer o deal - senao duplica.
