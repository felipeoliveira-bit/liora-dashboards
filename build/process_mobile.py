...
INJECT_DEALS = [
    ...
    {'deal_id': '1ae0904f-ec5c-4971-8870-652ca673ee29', 'deal_stage': 'REQUEST_TITULARIDADE', 'deal_lost_at': '', 'deal_lost_reason': '', 'rd_station_crm_id': '', 'deal_created_at': '2026-08-11T13:15:36', 'current_client_cnpj': '', 'current_client_cpf': '07738719427', 'current_client_name': 'JOSE FRANCINALDO DA SILVA FILHO', 'client_phone_number': '+5584986726311', 'current_client_state': 'RN', 'current_client_city': 'EXTREMOZ', 'distributor_short_name': 'NEOENERGIA COSERN', 'origin_campaign': '', 'origin_source': 'whatsapp-bot', 'internal_sales_classification': 'FS_Liora', 'sales_team': 'Field Sales', 'sales_organization_name': 'Liora', 'sales_channel_name': 'Field Sales Liora', 'sales_person_name': 'Thiago Firmo', 'sales_person_email': 'thiago.firmo@lioraenergia.com.br', 'current_total_bill_cost (R$)': '312.23', 'rd_bill_cost (R$)': '312.23', 'under_minimal_flag': '0', 'rd_distributor': 'NEOENERGIA COSERN', 'current_consumption': '0.244', 'is_current_consumption_estimated': 'false', 'current_consumption_filled': '0.244', 'consumption_group': '1. <= 0.5 MWh', 'proposal_id': '445deff9-5f45-46c4-a880-4a9e1d8780fb', 'proposal_created_at': '2026-08-11T13:15:36', 'accepted_proposal': 'true', 'product_name': 'LIORA_F_', 'energy_retailer_name': 'Liora Energia', 'has_valid_bill_uploaded': 'true', 'bill_id': '95a05e93-8e58-4e6c-8e3c-414669e58466', 'latest_contract_id': 'ef643887-0feb-417e-8923-fa910bd3fedf', 'latest_contract_created_at': '2026-08-11T13:20:31', 'latest_contract_signature_signed_at': '2026-08-11T10:23:39', 'latest_risk_analysis_result': 'APPROVED', 'latest_risk_analysis_created_at': '2026-08-11T13:30:37', 'latest_risk_analysis_comments': '', 'idle_days': '0', 'idle_days_group': '1. <= 1 dia', 'cancelation_date': '', 'ops_tt_status': 'N/A', 'ops_tt_status_reason': 'N/A', 'credit_product': '0', 'deal_credit_stage': '', 'latest_credit_analysis_result': ''},  # JOSE FRANCINALDO DA SILVA FILHO (Thiago Firmo/Natal, LIORA_F_ Cosern, Extremoz/RN) - risco APPROVED 13:30 11/08 na silver, mas o deal NUNCA materializou na gold sales_management (card818) e o bronze_gap nao pega (proposta anterior ao corte da silver); inject manual (Felipe 19/08); remover quando a gold refletir
]
INJECT_UC = {}
